...
How to execute:
    ...
    - ./chat_server_3 <port> <number_max_active_clients> <min_delay> <max_delay(>=min_delay)> <porcentage_lost>
    - ./chat_client_3 <name_machine> <port> <name> <min_delay> <max_delay(>=min_delay)> <porcentage_lost>
